...
Public Class frmMain
    ...
    Private Sub BackgroundWorker_Crea_STL_DoWork(sender As Object, e As DoWorkEventArgs) Handles BackgroundWorker_Crea_STL.DoWork
        ...
        If Cnt_Processi_Analisi < Processi.Count AndAlso Cnt_Processi_Attivi < GruppoProcessi Then
            If Processi(Cnt_Processi_Analisi).Stato = clsProcesso.enmStato.Fermo Then
                Cnt_Processi_Attivi += 1
        ...
        '        Exit For
        '    End If
        '    If Cnt_Processi_Attivi < GruppoProcessi Then
        '        If p.Stato = clsProcesso.enmStato.Fermo Then
        '            Cnt_Processi_Attivi += 1
        '            p.Avvia()
