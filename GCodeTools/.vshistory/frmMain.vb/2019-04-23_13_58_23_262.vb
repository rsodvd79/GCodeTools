    ...
    Private Sub Modo5()
        ...
        Do While LI < Segmenti.Count
            ...
            Do
                ...
                stbR.AppendLine($"drw({sg.Origine.aStringaComplessa()},{sg.Angolo.ToString(CultureInfo.InvariantCulture)},{sg.Distanza.ToString(CultureInfo.InvariantCulture)},{sg.Layer.ToString(CultureInfo.InvariantCulture)},{sg.Primo.ToString(CultureInfo.InvariantCulture)})")
                ...
                'stbR.AppendLine("difference () {")
                'stbR.AppendLine($"cylinder(d={dblUgello.ToString(CultureInfo.InvariantCulture)},h={sg.Layer.ToString(CultureInfo.InvariantCulture)});")
                'stbR.AppendLine($"translate([0-{dblUgello.ToString(CultureInfo.InvariantCulture)},0-(({dblUgello.ToString(CultureInfo.InvariantCulture)}+0.2)/2),0-0.1])")
                'stbR.AppendLine($"cube([{dblUgello.ToString(CultureInfo.InvariantCulture)},{dblUgello.ToString(CultureInfo.InvariantCulture)}+0.2,{sg.Layer.ToString(CultureInfo.InvariantCulture)}+0.2]);")
                'stbR.AppendLine("};")
                'stbR.AppendLine("};")
