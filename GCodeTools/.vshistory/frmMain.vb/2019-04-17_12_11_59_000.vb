...
Public Class frmMain
    ...
    Private Class clsSegmento
        ...
        Public Sub New(_livello As Double, _layer As Double, _x1 As Double, _y1 As Double, _z1 As Double, _x2 As Double, _y2 As Double, _z2 As Double)
            Livello = _livello
            Layer = _layer
    ...
    Private Sub GCodeToSegmenti()
        ...
        Dim dblOX As Double = Double.MinValue
        Dim dblOY As Double = Double.MinValue
        Dim dblOZ As Double = Double.MinValue
        Dim dblOE As Double = Double.MinValue
        Dim dblOF As Double = Double.MinValue
                ...
                Select Case strP(0)
                    ...
                    Case "G1"
                        ...
                        If Distanza > 0 AndAlso dblDE > 0 Then
                            Segmenti.Add(New clsSegmento(intLi, intLa, dblOX, dblOY, dblOZ, dblDX, dblDY, dblDZ))
    ...
    Public Sub ControllaProcessi()
        ...
        Progresso(0, Processi.Count - 1, intCntProcessiCompletati)
    ...
    Private Sub Modo4()
        ...
        For LI As Integer = 0 To Segmenti.Count - 1
            Progresso(0, Segmenti.Count - 1, LI)
    ...
    Private Sub TimerControllo_Tick(sender As Object, e As EventArgs) Handles TimerControllo.Tick
        ...
        If intCntProcessiAttivi = 0 AndAlso Processi.Count > 0 Then
            ...
            Testo($"{vbCrLf}INCORPORO I FILE STL IN {Processi.First.FileStl}")
