    ...
    Private Sub Modo5()
        ...
        Do While LI < Segmenti.Count
            ...
            Do
                ...
                LI += 1
                intCNTS += 1
            Loop While LI < Segmenti.Count AndAlso Not Segmenti(LI).Primo AndAlso intCNTS < 11
            ...
            '    stbR.AppendLine($"cube([{sg.Distanza.ToString(CultureInfo.InvariantCulture)}, {dblUgello.ToString(CultureInfo.InvariantCulture)}, {sg.Layer.ToString(CultureInfo.InvariantCulture)}+2]);")
            '    stbR.AppendLine("};")
