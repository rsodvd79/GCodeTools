...
Public Class frmMain
    ...
    Private Class clsProcesso
        ...
        Public Sub New(_file As String)
            ...
            Processo.StartInfo.Arguments = $"-o ""{FileSCAD}.stl"" ""{FileSCAD}"""
    ...
    Private Sub Modo1()
        ...
        For LI As Integer = Segmenti.First.Livello To Segmenti.Last.Livello
            ...
            'Dim PrimoSegmento As clsSegmento = Nothing
            ...
            'Processi.Last.Segmento = PrimoSegmento
            ...
            stbF.AppendLine($"import(""{FO.Replace("\", "/")}.stl"", convexity=5);")
    ...
    Private Sub Modo3()
        ...
        For LI As Integer = 0 To Segmenti.Count - 1
            ...
            If Processi.Count > 0 Then
                stbR.AppendLine($"import(""{$"{Processi.Last.FileSCAD}.stl"}"", convexity=5);")
            ...
            AddHandler Processi.Last.Finito, Sub(ps, pe)
                                                 ...
                                                 '    My.Application.DoEvents()
                                                 'Loop While Not IO.File.Exists(IO.Path.Combine(strTF, $"{Processi.First.FileSCAD}.stl"))
